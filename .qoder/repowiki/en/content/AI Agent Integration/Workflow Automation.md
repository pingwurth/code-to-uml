...
- Environment: install.js sets CTU_HOME and installs the skill into agent toolchains
...
- CTU_HOME Initialization (install.js): Sets the project root as CTU_HOME, installs the skill into agent tool directories, and writes shell profile entries on Unix-like systems or environment variables on Windows.
...
- install.js sets CTU_HOME to the project root and installs the bundled skill into agent tool directories. It supports multiple tools and writes shell profiles or Windows environment variables.
...
User->>Installer : node install.js [tools...]
...
**Section sources**
- [install.js:27-77](file://install.js#L27-L77)
...
- [install.test.js:57-63](file://test/install.test.js#L57-L63)
